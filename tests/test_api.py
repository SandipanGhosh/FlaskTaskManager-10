...
class APITests(unittest.TestCase):
    ...
    def test_collection_endpoint_returns_correct_data(self):
        ...
        self.assertIn(b'Complete the lessons', response.data)
        self.assertIn(b'Complete the course', response.data)
    ...
    def test_resource_endpoint_returns_correct_data(self):
        ...
        self.assertEquals(response.mimetype, 'application/json')
        self.assertIn(b'Complete the course', response.data)
        self.assertNotIn(b'Complete the lessons', response.data)
